...
object RiftEffect {
    ...
    private fun dustTransitionRenderer(): ParticleRenderer =
        ParticleRenderer { center, points, viewers ->
            for (v in points) {
                ...
                for (viewer in viewers) {
                    viewer.spawnParticle(
                        ...
                        0.0, 0.0, 0.0,
                        0.0,
                        Particle.DustTransition(RIFT_COLOR, FLASH_COLOR, 1.2f)
                    )
                }
            }
        }
